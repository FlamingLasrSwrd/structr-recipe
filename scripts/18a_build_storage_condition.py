"""Build ContainerObject.hasStorageCondition. See
mealplanner/storage_condition_schema.py. Storage Condition vocabulary
(Fridge/Freezer/Pantry) already exists from step 5 -- nothing to seed.

Run with: python3 scripts/18a_build_storage_condition.py
"""
...
from mealplanner.storage_condition_schema import RELATIONSHIPS
