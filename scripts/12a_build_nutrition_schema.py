"""Build the NutrientProfile schema. See mealplanner/nutrition_schema.py.

Run with: python3 scripts/12a_build_nutrition_schema.py
"""
...
from mealplanner.nutrition_schema import PROPERTIES, RELATIONSHIPS
...
def main():
    ...
    print("\nNutrition schema build complete.")
